-- ==========================================================================
-- Align search_listings_filtered RPC with actual Supabase listings schema
-- ==========================================================================
-- Actual listings columns: id, vin, year, make, model, title, price, mileage,
-- location, detail_url, image_url, drivetrain, motor_type, transmission, etc.
-- No: trim, exterior_color, interior_color, fuel_type, image_urls, sources
-- ==========================================================================
